          ...
          <tr>
            <td align="center" bgcolor="#f3f3f3">
              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <!-- content -->
                <tr>
                  <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#7f8c8d; line-height:29px;">Prezado cliente, <br> Obrigado por escolher o Grupo ETARP.  <br> Nota de Cobrança: <?php echo htmlspecialchars( $numero_nota, ENT_COMPAT, 'UTF-8', FALSE ); ?> <br> Vencimento: <?php echo htmlspecialchars( $data_vencimento, ENT_COMPAT, 'UTF-8', FALSE ); ?> </td>
                </tr>
                <!-- end content -->
                <tr>
                  <td height="50"></td>
