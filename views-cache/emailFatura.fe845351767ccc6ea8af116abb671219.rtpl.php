          ...
          <tr>
            <td align="center" bgcolor="#f3f3f3">
              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <!-- title -->
                <tr>
                  <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:36px; color:#3b3b3b; font-weight: bold; letter-spacing:4px;">Nota de Cobrança de Locação</td>
                </tr>
                <!-- end title -->
                <tr>
                  <td align="center">
                ...
                <!-- content -->
                <tr>
                  <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#7f8c8d; line-height:29px;">Prezado cliente, <br> Obrigado por escolher o Grupo ETARP. <br> Segue abaixo o link de sua nota. <br> Nota de Cobrança: <?php echo htmlspecialchars( $numero_nota, ENT_COMPAT, 'UTF-8', FALSE ); ?> <br> Vencimento: <?php echo htmlspecialchars( $data_vencimento, ENT_COMPAT, 'UTF-8', FALSE ); ?> </td>
                </tr>
                <!-- end content -->
                <tr>
                  <td height="50"></td>
          ...
          <tr>
            <td bgcolor="#FFFFFF" style="border-bottom-left-radius: 4px;border-bottom-right-radius: 4px;" align="center">
              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <!-- preference -->
                <tr>
                  <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#7f8c8d; line-height:29px;">Em caso de dúvidas, entre em contato com um dos nossos canais de atendimento: <br>Central de Atendimento: (16) 3289-5501 <br>Cordialmente,<br>Grupo ETARP - Financeiro<br>contabilidade@etarp.com.br </td>
                </tr>
                <!-- end preference -->
                <tr>
                  <td height="30"></td>
